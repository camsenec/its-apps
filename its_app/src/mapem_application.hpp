...
#ifndef MAPEM_APPLICATION_HPP_EUIC2VFR
#define MAPEM_APPLICATION_HPP_EUIC2VFR
...
class MapemApplication : public Application
{
public:
    MapemApplication() = default;
...
protected:
    vanetzaExtension::asn1::Mapem createMessageSkeleton();
};

#endif /* MAPEM_APPLICATION_HPP_EUIC2VFR */