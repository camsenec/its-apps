...
#ifndef SPATEM_APPLICATION_HPP_EUIC2VFR
#define SPATEM_APPLICATION_HPP_EUIC2VFR
...
class SpatemApplication : public Application
{
public:
    SpatemApplication() = default;
...
protected:
    vanetzaExtension::asn1::Spatem createMessageSkeleton();
};

#endif /* SPATEM_APPLICATION_HPP_EUIC2VFR */